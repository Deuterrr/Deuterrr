```bash
deu@fridge:~/portfolio$ vim my-kisah.ini
```
...
; I guess it starts pretty simply.
; I’m a computer science student who once found math interesting—
;     just not enough to spend a lifetime solving it by hand.
; At some point, it clicked:
;     if something can be computed,
;     maybe I don’t have to be the one doing it.
; That thought turned into a habit—
...
; No big awards, no extraordinary titles—
;     just projects, curiosity, and a lot of trial and error.
; But I think there’s value in that...
; It means everything I know, I had to figure out piece by
;     piece.
